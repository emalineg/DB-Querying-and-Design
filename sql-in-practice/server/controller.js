//require dotenv and attach config method
require('dotenv').config()

//deconstruct CONNECTION STRING from process.env 
const {CONNECTION_STRING} = process.env

//require sequelize and save to variable 

const Sequelize = require('sequelize')

//initialize new Sequelize instance passing in connection string and object
